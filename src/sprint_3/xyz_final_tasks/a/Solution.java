...
* тоже O(log n), получается что общая сложность поиска будет О (2 log n)
-- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
* В процессе поиска дополнительной памяти под поиск не выделяется,
* получается что пространственную сложность можно представить как О(1)
* */
